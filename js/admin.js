...
btnUpdateProductIn.addEventListener("click", (e) => {
    ...
    let imgProductOld = products[indexCur].img; // Ảnh cũ
    ...
    // SỬA: Lấy src hiện tại của ảnh preview
    ...
    if (imgProductCur != imgProductOld || titleProductCur != titleProduct || curProductCur != curProduct || descProductCur != descProduct || categoryText != categoryProduct) {
        let productadd = {
            id: idProduct,
...
btnAddProductIn.addEventListener("click", (e) => {
    ...
    // SỬA: Lấy trực tiếp src (đã là Base64) thay vì dùng getPathImage
